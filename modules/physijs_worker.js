...
module.exports = function (workerToSceneMessageHandler, Ammo) {
  ...
  public_functions.init = function (params) {
    ...
    if (SUPPORT_TRANSFERABLE) {
      ...
      worldreport = new Float32Array(
        2 + REPORT_CHUNKSIZE * WORLDREPORT_ITEMSIZE
    ...
    world = new Ammo.btCollisionWorld(
      dispatcher,
      broadphase,
  ...
  */
  ...
  public_functions.addVehicle = function (description) {
    ...
    vehicle_tuning.set_m_maxSuspensionTravelCm(
  ...
  public_functions.addWheel = function (description) {
    if (_vehicles[description.id] !== undefined) {
      ...
      if (description.tuning !== undefined) {
        ...
        tuning.set_m_suspensionStiffness(
          description.tuning.suspension_stiffness
        );
        ...
        tuning.set_m_maxSuspensionForce(
          description.tuning.max_suspension_force
        );
      }
    ...
    if (SUPPORT_TRANSFERABLE) {
      vehiclereport = new Float32Array(
        1 + _num_wheels * VEHICLEREPORT_ITEMSIZE
